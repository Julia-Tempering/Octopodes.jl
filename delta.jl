...
# ╔═╡ 002daebe-c270-40ee-8f0b-58670068c4c0
 mcmc_subsample = @bind mcmc_subsample PlutoUI.Slider(10:(size(assignments)[2]); show_value=true)

# ╔═╡ 95764e0b-ed3b-45ea-b34e-04611c635dc1
stars_subsample = @bind stars_subsample PlutoUI.Slider(10:300; show_value=true)
